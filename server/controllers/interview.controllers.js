...
export const analyseResume = async(req, res) => {
    try{
      ...
      //now we extract all the pages and convert the data into text
      let resumeText = ""
...
export const generateQuestion = async(req, res) => {
    try{
       ...
       if(user.credits < 50){
        return res.status(400).json({message: "Not enough credits to give interview, minimum 50 credits required."});
       }
