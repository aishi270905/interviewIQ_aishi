        ...
        <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
            ...
            className='relative bg-gradient-to-br from-green-50 to-green-100 p-12 flex flex-col justify-center'>
                ...
                <p className='text-gray-600 mb-10'>
                    Practice real interview scenarios powered by AI. Improve communication, technical skills, and confidance.
                </p>
            ...
            >
             ...
             <div className='space-y-6'>
                ...
                {!analysisDone && (
                    ...
                    className='border-2 border-dashed border-gray-300 rounded-xl text-center p-8 cursor-pointer hover:border-green-500 hover:bg-green-50 transition'>
