          ...
          <div className='text-center mb-28'>
              ...
              <div className='flex flex-wrap justify-center gap-4 mt-10'>
                <motion.button
                 ...
                 className='bg-black text-white px-10 py-3 rounded-full hover:opacity-90 trasition shadow-md'>
                 Start Interview
                </motion.button>
                  ...
                  [
                    {
                      ...
                      desc: "Scores communication, technical accuracy and confidance."
                    },
                    {
                      image: resumeImg,
              ...
              <div className='grid md:grid-cols-2 gap-10'>
                {
                  [
                    ...
                    {
                      image: confidenceImg,
                      title: "Confidance Detection",
                      desc: "Basic tone and voice analysis."
                    },
                    {
                      image: creditImg,
