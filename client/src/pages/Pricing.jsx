...
function Pricing() {
  ...
  const [loadiingPlan, setLoadingPlan] = useState(null);
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "₹500",
      credits: 650,
      description: "Best value for serious job preperation.",
      features: [
      ...
      <div className='max-w-6xl mx-auto mb-14 flex items-start gap-4'>
        ...
        <div className='text-center w-full'>
          ...
          <p className='text-gray-500 mt-3 text-lg'>
            Flexible pricing to match your interview preperation goals.
          </p>
        </div>
      </div>
